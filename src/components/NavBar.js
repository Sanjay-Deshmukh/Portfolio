...
const CustomLink = ({ href, title, className = "" }) => {
    ...
    return (
        <Link href={href} className={`${className} relative group`} id={`nav-${title.toLowerCase()}`}>
            {title}
            <span
...
const CustomMobileLink = ({ href, title, className = "", toggle }) => {
    ...
    return (
        <button
            ...
            onClick={handleClick}
            id={`mobile-nav-${title.toLowerCase()}`}
        >
            {title}
            <span
        ...
        >
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                <nav>
                    ...
                    <CustomLink href="/articles" title="Certificates" className="mx-4" />
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    ...
                    {mounted && (
                        <button
                            ...
                            className={`w-8 h-8 flex items-center justify-center rounded-full p-1 ml-3
          ...
          z-30 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32"
                >
                    <nav className="flex items-center flex-col justify-center">
                        ...
                        <CustomMobileLink href="/articles" title="Certificates" toggle={handleClick} />
